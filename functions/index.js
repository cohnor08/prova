...
body{font-family:-apple-system,Helvetica,Arial,sans-serif;margin:0;color:#0F172A;background:#F1F5F9}
.wrap{max-width:640px;margin:0 auto;padding:34px 30px;background:#fff}
...
.cap{margin:22px 0 8px;font-size:11px;font-weight:800;letter-spacing:.8px;color:#94A3B8;text-transform:uppercase}
.bars{display:flex;gap:10px;align-items:flex-end;height:130px;padding:16px;background:#F8FAFC;border:1px solid #E2E8F0;border-radius:16px}
.bars.empty{align-items:center;justify-content:center}
.emptymsg{color:#94A3B8;font-size:14px;text-align:center}
