...
<meta name="color-scheme" content="dark"><meta name="supported-color-schemes" content="dark"><style>
*{box-sizing:border-box}
body{font-family:-apple-system,'SF Pro Display',Helvetica,Arial,sans-serif;margin:0;background:#0A0A0B;color:#F2F2F4}
.wrap{max-width:600px;margin:0 auto;padding:40px 26px}
...
.bars{display:flex;gap:9px;align-items:flex-end;height:132px;padding:18px;background:#141416;border:1px solid #232326;border-radius:18px}
...
.stat{flex:1 1 44%;background:#141416;border:1px solid #232326;border-radius:18px;padding:18px}
.stat .v{font-size:24px;font-weight:800;letter-spacing:-.3px}.stat .l{font-size:13px;color:#8A8A90;margin-top:5px}
.note{margin-top:14px;background:#141416;border:1px solid #232326;border-radius:18px;padding:18px 20px}
